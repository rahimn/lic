...
\begin{theorem}
\label{ThmB}
Suppose $f$ is a block-diagonal matrix where each block is a tuple $f_k$ such that $Z(f_k)=\{0\}$.
...
\end{equation}
If $f$ is block-diagonal of the form \eqref{block-diagonal}, then by polarising King's formula we obtain
\begin{equation}
\label{lemma 2}
